...
class FrameworkCopySQLiteDatabase implements SupportSQLiteDatabase {
	 ...
	 */
	FrameworkCopySQLiteDatabase(SQLiteDatabase delegate) {
		mDelegate = delegate;
	}

	@Override
	public SupportSQLiteStatement compileStatement(String sql) {
		return new FrameworkCopySQLiteStatement(mDelegate.compileStatement(sql));
	}
	...
	public Cursor query(final SupportSQLiteQuery supportQuery) {
		return mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() {
			...
			public Cursor newCursor(SQLiteDatabase db, SQLiteCursorDriver masterQuery,
				...
				supportQuery.bindTo(new FrameworkCopySQLiteProgram(query));
