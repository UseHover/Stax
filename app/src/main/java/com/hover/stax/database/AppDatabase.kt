...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val M42_43 = Migration(42, 43) { database -> //accounts table changes
            database.execSQL("ALTER TABLE channels ADD COLUMN institution_type TEXT DEFAULT 'bank'")
            database.execSQL("ALTER TABLE accounts ADD COLUMN institution_type TEXT DEFAULT 'bank'")
            database.execSQL("ALTER TABLE accounts ADD COLUMN subscription_id INTEGER DEFAULT -1")
        }
