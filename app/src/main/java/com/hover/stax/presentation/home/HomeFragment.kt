...
class HomeFragment : Fragment(), FinancialTipClickInterface, BalanceTapListener {
    ...
    private fun getHomeClickFunctions(): HomeClickFunctions {
        ...
        fun onClickedAddNewAccount() = (requireActivity() as MainActivity).checkPermissionsAndNavigate(MainNavigationDirections.actionGlobalAddChannelsFragment().setIsForTelecom(true))
