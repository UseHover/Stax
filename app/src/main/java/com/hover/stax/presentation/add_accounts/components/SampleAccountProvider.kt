...
class SampleAccountProvider : PreviewParameterProvider<List<Account>> {
	override val values: Sequence<List<Account>> = sequenceOf(listOf(
		...
		USDCAccount("Stellar USDC", "Stellar USDC", "", "ABCDEF0123456789", -1, CRYPTO_TYPE, "Stellar color 1", "stellar color 2",
			"native", null, false)
	))
}