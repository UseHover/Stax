...
public class StaxCardView2 extends FrameLayout {
	...
	public StaxCardView2(Context context, AttributeSet attrs) {
		super(context, attrs);
		getAttrs(context, attrs);
		LayoutInflater.from(context).inflate(R.layout.stax_card_view2, this);
