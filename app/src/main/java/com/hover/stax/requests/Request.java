...
public class Request {
    ...
    public static String decryptBijective(String value, Context c) {
        ...
        for(int i = 0; i<valueChar.length; i++) {
            switch (valueChar[i]) {
                case 'g': result[i] = bijectiveExtReverse(c)[0];
                    break;
                case 'j': result[i] = bijectiveExtReverse(c)[1];
                    break;
                case 'r':  result[i] = bijectiveExtReverse(c)[2];
                    break;
                default:
    ...
    private String encryptBijective(String value, Context c) {
        ...
        for(int i = 0; i<valueChar.length; i++) {
            switch (valueChar[i]) {
                case '.' : result[i] = bijectiveExt(c)[0];
                    break;
                case '-': result [i] = bijectiveExt(c)[1];
                    break;
                case ',' : result[i] = bijectiveExt(c)[2];
                    break;
                default:
