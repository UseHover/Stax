...
import com.hover.stax.presentation.add_account.AddAccountScreen
import com.hover.stax.presentation.home.HomeScreen
...
class AddChannelsFragment : Fragment(), ChannelsAdapter.SelectListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.root.setContent {
            AddAccountScreen(channelsViewModel)
        }
...
//        binding.countryDropd chown.setListener(this)
//    }
//
