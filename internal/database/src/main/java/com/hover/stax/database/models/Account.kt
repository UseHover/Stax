...
data class Account(
    ...
    constructor(alias: String, channel: Channel, isDefault: Boolean, simSubscriptionId: Int) : this(
        ...
        channel.institutionType,
        channel.countryAlpha2,
        channel.id,
        channel.primaryColorHex,
        channel.secondaryColorHex,
        isDefault,
        simSubscriptionId
    )
    ...
    fun updateBalance(parsed_variables: HashMap<String, String>) {
        ...
        latestBalanceTimestamp =
            if (parsed_variables.containsKey("update_timestamp") && parsed_variables["update_timestamp"] != null) {
